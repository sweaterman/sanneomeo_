...
public class Constants {
  ...
  public static final String[] SECURITY_HTTP_EXCLUDE_URIS = {"/user/after/login", "/user/token","/user/info", "/user/challenge", "/main/**", "/trail/recommend/**", "/trail/info/**","/spot/**",
                                                              "/mountain/trail/**", "/mountain/photo/**", "/mountain/info/**", "/mountain/position/**", "/mountain/review/**", "/mountain/season", "/mountain/hundred","/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**"};
